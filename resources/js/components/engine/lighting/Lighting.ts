...
export class Lighting {
  ...
  constructor() {
    ...
    this.cameraSpotLight.position.set(0, 2.0, 4.8); 
    this.cameraSpotLight.target.position.set(0, 3.4, -2.8); 
